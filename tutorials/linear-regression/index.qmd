...
Vi gör en graf med `plot()` och lägger sedan till en regressionslinje med `abline()`
...
Antalet frön ökad med ökad höjd (linjär regression, F<sub>1,18</sub> = 68.681, p \< 0.001, R<sup>2</sup> = 0.78).
