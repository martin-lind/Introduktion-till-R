...
Antalet frön ökad med ökad höjd hos växten (linjär regression, F = 68.681, d.f. = 1 och 18, p \< 0.001, R<sup>2</sup> = 0.78).

Man kan uttrycka den meningen på många sätt, ett alternativ är:

Ju högre växten är, desto fler frön har den (linjär regression, F = 68.681, d.f. = 1 och 18, p \< 0.001, R<sup>2</sup> = 0.78).
