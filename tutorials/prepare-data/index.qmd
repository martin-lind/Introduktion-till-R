...
För att kunna analysera data måste vi ställa upp våra data på ett sätt som R accepterar. Vi skriver alltid in våra data i ett kalkylblad (exempelvis Excel, Libreoffice, Numbers eller liknande) varefter vi exporterar vårt dataset till R.
...
**Undvik väldigt långa namn.** När du gör statistik behöver du skriva in namnet på dina variablar i din kod. För att få en översiktlig kod och undvika att skriva fel är det en fördelen om namnen är korta, men ändå förklarar tydligt vad de beskriver. `Kroppslangd_i_mm_fran_nabbspets_till_mittersta_stjartpennans_slut` är ett alldeles för långt namn, medan `Kroppslangd` är ett kort och bra namn. Beskrivningen av hur kroppslängd mätts är nödvändigt att skriva upp i din metodik, men behövs inte i ditt namn på variabeln.
