...
En väldokumenterad scriptfil (kallas också en *väl annoterad scriptfil*) är enkel att återvända till för att återupprepa analyserna elelr tillämpa dem på nya dataset. Använder man RStudio förgas kommentarerna automatiskt i en avvikande färg.
...
Kör koden enligt instruktionen ovan:
...
Den raden kod vi körde innehåller inga objekt, så den kan köras oberoende av andra rader. Men testa att köra raden:
`studiemedel2025 - studiemedel2024`

Får du ett felmeddelande?
`Error: object 'studiemedel2025' not found`
...
Du måste först köra de raderna, så att R vet vad objekten studiemedel2024 och studiemedel2025 innehåller. Sedan kan du köra raden vi testade på nytt. Då skall det fungera!
...
Skapa ett script som räknar ut hur många år en person fyller i år (till exempel hur många år du fyller i år). Kommentera scriptet väl. Försök själv, men kör du fast kan du tjuvkika nedan (under Code).
...
Glöm inte att spara ditt script med ett passande namn på din hårddisk. I R måste du skriva in filändelsen .R när du sparar filen första gången, medan RStudio automatiskt lägger till den filändelsen.