...
![](images/R_outline.png){width="1000"}
...
Vi stestar några funktioner för att få summarisk statistik på ett antal värden, som vi sparar i ett objekt som vi kallar `counts`
