...
I **R** kan du välja Working Directory genom att klicka följande i menyerna (om du använder Mac):

![](images/R-setwd.png){width="600"}

Använder du **R för Windows** går du in i menyn ***File*** och väljer ***Change dir***.
