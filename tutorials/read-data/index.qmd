...
Det finns många sätt att läsa in en fil, det beror dels på om du använder R eller R Studio, men också på om du vill dokumentera vad filen herer och var den ligger i ditt script (rekommenderas för reproducerbarhet). Slutligen kan valet bero på om du använder R-projekt eller inte.
