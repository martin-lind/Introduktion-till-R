...
I **R** kan du välja Working Directory genom att klicka ***File -\> Change dir...*** i menyerna (om du använder **Windows**). Om du inte får upp menyvalet kan du först behöva klicka någonstans i din ***Console*** och sedan försöka på nytt.

![](images/R_windows_setwd.jpg){fig-align="left"}

Använder du **Mac** (OSX) ser det ut på följande sätt:

![](images/R-setwd.png){width="600"}

**RStudio** finns motsvarande menyval:
...
1.  Ta du reda på den absoluta sökvägen till din Working Directory med `getwd()` . Markera och kopiera sökvägen.
...
2.  Skriv in (eller klistra in) den absoluta sökvägen i ditt script, inuti funktionen `setwd()`
...
`sep="\t"` betyder att alla värden/celler är separerade med TAB (det är en tab-separerad textfil).
