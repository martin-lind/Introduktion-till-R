...
Fortsätt med att läsa in ett dataset och ge det ett namn, i det här fallet kallar vi det *tree.data*. En detalerad beskrivning i hur man läser in filer finns i vår tidigare tutorial [Läsa in data i R](https://martin-lind.github.io/Introduktion-till-R/tutorials/read-data/#l%C3%A4s-in-filen).
