...
Vi får en tabell med jämförelser. Om vi börjar med *Kolumn A* och *Rad B* får vi p-värdet `0.0010.` Det betyder att täckningsgraden för blåber skiljer sig åt mellan skogarna A och B. 

*Kolumn A* och *rad C* ger ett p-värde på `0.0971.` Täckningsgradenb skiljer sig alltså **inte** åt mellan skogarna A och C.

*Kolumn B* och *rad C* ger ett p-värde på `0.0343.` Täckningsgraden av blåbär skiljer soig åt mellan skogarna B och C.
