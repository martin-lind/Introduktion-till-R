...
Icke-parametriska metoder bygger på att värderna rankas, dvs är ett visst värde generellt högre eller lägre än de andra värderna. Testen använder sig därmed inte av de exakta mätvärderna och tappar därmed mycket information (de är svaga test), de har svårare att upptäcka mönster som faktiskt finns och skall därmed bara användas i nödfall.
