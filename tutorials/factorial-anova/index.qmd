...
Börja med att läsa in ett dataset och ge det ett namn, i det här fallet kallar vi det *nutrients*.
...
`$ Weight: int` betyder att värderna i kolumnen `Weight` är *decimaltal*
