---
title: "Faktoriell (tvåvägs) ANOVA"
---
...
Notera att du bör konstruera din posthoc-design för att undersöka det du identifierat som interaktion i din plot. Om du byter plats på faktorerna i formeln (`~ Species | Nutrient_level`) testar du om de två arterna skiljer sig åt vid en given näringstillgång, vilket inte är vad du var ute efter att testa. Ett robust alternativ är att testa alla möjliga interaktioner, även de biologiskt ointressanta. Då konstruerar du formeln med ett multiplikationstecken `emmeans(m.size_nutrient, pairwise ~ Nutrient_level * Species)`. Notera att det innebär fler parvisa tester, med ytterligare justerade p-värden.

## Presentera din statistiska analys

Vi har en signifikant interaktion mellan näring och art (faktoriell ANOVA, F = 108,2, df = 1 och 56, p \< 0.001) vilket betyder att hur vikten påverkas av näring skiljer sig åt för de två arterna. Medan art B väger mer vid hög näring (post-hoc, t = 12.803, df = 56, p \< 0.001) har näring ingen effekt på vikten hos art A (post-hoc, t = -1.905, df = 56, p = 0.062). I tillägg till interaktionen är huvudeffekten av såväl näring (faktoriell ANOVA, F = 59.4, df = 1 och 56, p \< 0.001) som art (faktoriell ANOVA, F = 347,6, f.g. = 1 och 56, p \< 0.001) signifikanta.
